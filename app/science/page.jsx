    ...
    return (
      <div className="flex flex-col justify-center items-center pt-3 sm:pt-10">
        {data.articles.map((article) =>
          article.urlToImage ? (
            <div className="border-2 border-gray-700 rounded-sm sm:w-2/5 mx-3 sm:mx-0 mb-3 sm:mb-10 p-3 sm:p-10 font-semibold">
              <div>
                <img
              ...
              <div>
                ...
                <div className="flex flex-col justify-center items-center">
                  <Link
                    href={article.url}
                    target="_blank"
                    className="bg-saffron text-gray-200 hover:text-white rounded-sm px-3 py-2"
                  >
                    Read More
                  </Link>
                </div>
